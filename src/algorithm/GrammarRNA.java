...
public class GrammarRNA {
    ...
    //Variable to save all the trees of the final RNA
    public static ArrayList<ParseTreeWithScore> winner; 
    public static String finalChain;
        
    /**
     * Get the probability in a exact position
     * @param index
     * @return 
     */
    public static double getProbability(int index) {
    ...
    /**
     * Return the list of probabilities actually used
     * @return probability
     */
    ...
    /**
     * Return the evolutive algorithm to calculate the RNA trees
     * @param chain
     * @param iterations
     * @param beginSize
     * @param finalSize
    ...
    /**
     * Fill the ArrayList with the trees of the RNA
     * @param finalSizeRNA
     * @param numberIterations 
     */
    public static void run(int finalSizeRNA, int numberIterations) {      
        //Initially pair
        ...
        winner = theBest(begin, numberIterations, beginSizeObjetive, finalSizeRNA);
    ...
    /**
     * Return the tree in a exact point of time
     * @param time
     * @return Tree in exact time
     */
    public static String showResult(int time){
        return winner.get(time).toString();
    }
